...
public class List {
    ...
    private int[]list;
    /**.
     * It is the attribute declaration for integer array.
     */
    /*
    ...
    */
     ...
     */
     private int size;
     /**
      * It is the attribute declaraation for integer variable size.
      */
    ...
    public List() {
        ...
        */
        list = new int[10];
        /**.
         * It is intialization of int array list.
         */
        /*
        ...
        */
        size = 0;
        /**.
         * It is the intialization of int variable size.
         */
    ...
    public List(int x) {
        /**
         * It is the overloading counstructor.
         */
        list = new int[x];
    }
    /*
